...
#include <Arduino.h>
SoftwareSerial sim800(1, 2); // установка контактов 2 и 3 для программного порта (для микроконтроллера ардуино убать букву D)
bool rele = HIGH;
int relpin = 13; //пин реле
int LED = 12; //светодиод
char* adminNumber[] = {"+7хххххххххх", "+7ххххххххх"};
char i;
